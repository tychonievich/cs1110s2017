...
if __name__ == "__main__":
    ...
    b = from_text(40,50,"Type \"0\"","Arial",40,"red", italic=True, bold=False)
    b.speedx = 3
    b.left += 2
    b.y = 100
    b.move_speed()
    ...
    def tick(keys):
        if keys:
            if pygame.K_0 in keys: b.color = 'red'
            elif pygame.K_1 in keys: b.color = 'blue'
            elif pygame.K_2 in keys: b.color = 'green'
