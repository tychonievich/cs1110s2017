...
<td class="day Friday " id="2017-02-17"><span class="date">17 Feb</span>decisions -- `elif`{.python} and logical operators (not on exam 1)<br/>rest of §6.1--6.2<br/>**never** use `exit()`{.python} from §6.3<br/></td>
</tr><tr>
